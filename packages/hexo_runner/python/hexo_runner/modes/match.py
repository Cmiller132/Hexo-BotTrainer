...
from ..records import GameResult, RecordSink
...
def run_match(
    ...
    through the public API and sends each player only a cloned engine state.
    """

    return run_match_loop(spec, players, sink)
