...
old hexformer_ar group, and unit-test the group laws (`tests/test_hexgnn_d6.py`).
...
hexgnn's model is D6-INVARIANT by construction (invariant node/edge features +
