...
from .architecture import RestnetNetwork, optimized_restnet_for_inference
...
def _contains_restnet_network(model: torch.nn.Module) -> bool:
    return any(isinstance(module, RestnetNetwork) for module in model.modules())
