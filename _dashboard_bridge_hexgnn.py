...
WT = Path("/mnt/e/Hexo-BotTrainer-hexgt/runs/hexgnn_rl_main1")   # worktree RL run (read) -- the ACTIVE run
EVAL = WT / "eval"
SELFPLAY = WT / "selfplay"                                       # per-game .npz (read)
MAIN = Path("/mnt/e/Hexo-BotTrainer/runs/hexgnn_rl_main1")        # main-tree mirror (write) -> :8080 dashboard
