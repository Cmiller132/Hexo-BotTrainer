...
# / NO PCR per the owner. Everything else as proven: n=5 candidates, steerable=4 D6
...
--value-pma-seeds 2 --steerable-channels 4 --n 5 \
...
--widening-max-children 128 --soft-z-lambda 0"
